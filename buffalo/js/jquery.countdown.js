...
function Countdown() {
    ...
    // a bit jank but there is no interval it seems on when to call the ticker
    // ever hour should be fine to remap the day counter
		if (drawStart - animationStartTime >= 36000000) {
